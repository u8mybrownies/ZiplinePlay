...
class TestFactory(TestCase):
    ...
    def test_load_bars_from_yahoo(self):
        ...
        assert data.major_axis[-1] == pd.Timestamp('2013-3-1 00:00:00+0000')
        for stock in stocks:
